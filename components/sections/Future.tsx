        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="space-y-6">
            <ScrollAnimate direction="right">
              <div className="p-6 bg-secondary-muted rounded-xl border-l-4 border-secondary">
            ...
            <ScrollAnimate direction="right" delay={100}>
              <div className="p-6 bg-accent-muted rounded-xl border-l-4 border-accent">
            ...
            <ScrollAnimate direction="right" delay={200}>
              <div className="p-6 bg-primary-muted rounded-xl border-l-4 border-primary">
